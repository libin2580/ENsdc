 ...
 */
public class SubCourseAdapterNew extends RecyclerView.Adapter<SubCourseAdapterNew.PersonViewHolder> {
    ...
    public SubCourseAdapterNew(List<CoursesModel> course_details, Context context){
    ...
    public static class PersonViewHolder extends RecyclerView.ViewHolder  {
        ...
        PersonViewHolder(View itemView) {
            ...
            tick_lay= (LinearLayout) itemView.findViewById(R.id.tick_lay);
...
//          public boolean onTouch(View v, MotionEvent event) {
                ...
                if (!personViewHolder.chk.isChecked())
                {
                    ...
                    dialog.setTitleText(course_details.get(i).getCrces()+ "?")
                            .setContentText("")
                            .setCancelText("ADD TO CART")
                            ...
                            .setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
                                ...
                                public void onClick(SweetAlertDialog sDialog) {
                                    ...
                                    count++;
                                    personViewHolder.tick_lay.setBackgroundResource(R.color.Orange);
                                    personViewHolder.chk.setBackgroundResource(R.drawable.ic_done_white_24dp);
                                    ...
                                    if (dataHelper.verification(coursename))
                                    {
                                        ...
                                        for( int p=0;p<crc_list.length;p++)
                                        {
                                            if( clckd_crcnam.equals(crc_list[p]) ) {
                                                ...
                                                final SweetAlertDialog dialog1 = new SweetAlertDialog(context,SweetAlertDialog.NORMAL_TYPE);
...
//
                            ...
                            .setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener(){
                                ...
                                public void onClick(SweetAlertDialog sweetAlertDialog) {
                                    ...
                                    personViewHolder.chk.setBackgroundResource(R.drawable.ic_done_black_24dp);
                                    personViewHolder.tick_lay.setBackgroundResource(R.color.rowcrc);
                    ...
                    //Me cahnged 17/02/12018



                   // dialog.findViewById(R.id.custom_close).setVisibility(View.VISIBLE);
                   /* dialog.findViewById(R.id.custom_close).setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
