...
//    public static final String MEMBER_TOTAL_PRICE = "total";
    ...
    static final String DB_NAME = "MEMBERS6";
    ...
    private static final String CREATE_TABLE_NW = "CREATE TABLE " + TABLE_COURSE + " (" + KEY_COURSE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"+ KEY_SUB_COURSE_ID + " TEXT,"  + KEY_SUB_COURSE + " TEXT )";
    ...
    public boolean verification(String _username) throws SQLException {
        ...
        try {
            String query = "SELECT COUNT(*) FROM "
                    + TABLE_COURSE + " WHERE " + KEY_SUB_COURSE + " = ?";
...
//    }
    ...
    public int updateCourse(String maincrc_id,String course,String subcourse,String subcourse_id) {
        ...
        // updating row
        return db.update(TABLE_COURSE, values, KEY_SUB_COURSE + " = ?",
    ...
    public void insertData( String subcourse,String subcourse_id) {
