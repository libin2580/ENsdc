...
public class ContactUsActivity1 extends AppCompatActivity implements OnMapReadyCallback {
...
//        });
        ...
        layfax.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final SweetAlertDialog dialog = new SweetAlertDialog(ContactUsActivity1.this,SweetAlertDialog.NORMAL_TYPE);
                dialog.setTitleText("Fax Number")
                        .setContentText("+971-2-55-47717")
                        .setConfirmText("OK")
              ...
              /*  final AlertDialog alertDialog = new AlertDialog.Builder(ContactUsActivity1.this).create();
                alertDialog.setTitle("Fax Number");
                alertDialog.setMessage("+971-2-55-47717");
...
*/
        ...
        imgwats.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                laywats.performClick();
//
//                if (ActivityCompat.checkSelfPermission(ContactUsActivity1.this, Manifest.permission.READ_CONTACTS) == PackageManager.PERMISSION_DENIED && ActivityCompat.checkSelfPermission(ContactUsActivity1.this, Manifest.permission.WRITE_CONTACTS) == PackageManager.PERMISSION_DENIED) {
//
//                    requestPermissions();
//                }
//                else
...
/// number is the phone number
    ...
    private void requestPermissions() {
        ActivityCompat.requestPermissions(ContactUsActivity1.this,
               ...
               /*     String ij = "+971529605389";
                   ...
                   /* String ij = "+971529605389";
                    ...
                    PackageManager pm = getPackageManager();
                                        ...
                                        String packageName = ContactUsActivity.this.getPackageName();
                                        PowerManager pm1 = (PowerManager)ContactUsActivity.this.getSystemService(Context.POWER_SERVICE);
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                            if (pm1.isIgnoringBatteryOptimizations(packageName))
                                                intentf.setAction(Settings.ACTION_IGNORE_BATTERY_OPTIMIZATION_SETTINGS);
                                            else {
                                                intentf.setAction(Settings.ACTION_REQUEST_IGNORE_BATTERY_OPTIMIZATIONS);
                                                intentf.setData(Uri.parse("com.whatsapp" + packageName));
                                            }
                                        }
                                        ContactUsActivity.this.startActivity(intentf);*//*
